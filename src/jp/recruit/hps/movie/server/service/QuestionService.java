...
public class QuestionService {
    ...
    public static Question createQuestion(Map<String, Object> input, Selection selection) {
    ...
    public static Question createQuestion(Selection selection, String name) {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("name", name);
        return createQuestion(map, selection);
    }
